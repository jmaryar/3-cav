...
(cl:defmethod cl:initialize-instance :after ((m <JointAngles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointAngles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name relaxed_ik_ros1-msg:<JointAngles> is deprecated: use relaxed_ik_ros1-msg:JointAngles instead.")))
...
(cl:defmethod angles-val ((m <JointAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader relaxed_ik_ros1-msg:angles-val is deprecated.  Use relaxed_ik_ros1-msg:angles instead.")
  (angles m))
